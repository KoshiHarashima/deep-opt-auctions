...
__C.dir_name = os.path.join("experiments", "additive_1x3_constrained_c0_5")
...
__C.train.update_frequency = 200
...
""" Allocation Constraint parameters (Augmented Lagrangian法用) """
# Enable allocation constraint
__C.train.use_allocation_constraint = True
# Lagrange乗数の初期値
...
# Lagrange乗数の更新頻度
__C.train.constraint_update_frequency = 100
# ペナルティパラメータの更新頻度
__C.train.constraint_up_op_frequency = 1000
